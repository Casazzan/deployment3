...
//      const [translateMenuCategory, setTranslateMenuCategory] = useState([
//       { translatedText: "Bowl" }, 
...
//           setTranslateMenuCategory(translatedArray)
...
//                     {subItems.map((subsubItems, subsubIndex) => {
//                       if (subItems == "bowl") {
//                         return ( <span onClick={() => {handlechange(index,subIndex,subsubIndex);}}><h3>{ translateMenuCategory[0].translatedText }</h3></span> )
//                       } 
//                       else if (subsubItems == "plate") {
//                         return ( <span onClick={() => {handlechange(index,subIndex,subsubIndex);}}><h3>{ translateMenuCategory[1].translatedText }</h3></span> )
//                       } 
//                       else if (subsubItems == "bigger plate") {
//                         return ( <span onClick={() => {handlechange(index,subIndex,subsubIndex);}}><h3>{ translateMenuCategory[2].translatedText }</h3></span> )
//                       }
//                       else if (subsubItems == "") {
//                         return ( <span></span> ) //return nothing
//                       }
