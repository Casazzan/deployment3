...
class App extends Component {
  ...
  callAPIAsync = async () => {
    // console.log((await fetch("https://panda-express-deployment-3.onrender.com/roster?id=2")).text());
    return (
      await fetch("https://panda-express-deployment-3.onrender.com/roster?id=2")
    ).text();
  };
    ...
    return (
      <Router>
        <Routes>
          ...
          <Route
            path="/ServerMenu/Checkout"
            element={<ServerCheckout />}
          ></Route>
          ...
          <Route
            path="/CustMainPage/PublicMenu"
            element={<PublicMenu />}
          ></Route>
          <Route
            path="/CustMainPage/StoreFinder"
            element={<StoreFinder />}
          ></Route>
