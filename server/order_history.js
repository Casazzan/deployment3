 ...
 * Ex: https://panda-express-deployment-3.onrender.com/order_history?id=3 <br>
 ...
 * Ex: https://panda-express-deployment-3.onrender.com/order_history/nextID <br>
 * Ex Response: {"nextID":5538} <br>
 *  <br>
 * - Get Full Order History <br>
 * Route: /order_history/summary <br>
 * Ex: https://panda-express-deployment-3.onrender.com/order_history/summary <br>
...
function parseParallelStrings(itemList, servingList, map) {
  ...
  for (i = 0; i < itemArr.length; i++) {
    ...
    else map.set(itemArr[i], servingArr[i]);
  }
}
...
router.get("/add", (req, res) => {
  ...
  parseParallelStrings(
    appetizer_ingredients,
    appetizer_amt_servings,
    itemAmountMap
  );
