 ...
 * Ex: https://panda-express-deployment-3.onrender.com/dish_list?id=3 <br>
 ...
 * Ex: https://panda-express-deployment-3.onrender.com/dish_list/summary <br>
 * Ex Response: \[{"dish_id":3,"dish_name":"bigger_plate","number_entrees":3,"number_sides":1,"price":"9.65"},...\] <br>
 *  <br>
 * - Order Price Query By Name <br>
 * Route: /dish_list/price?dish_id={id}&item={item_name}&item={item_name}... <br>
 * Ex: https://panda-express-deployment-3.onrender.com/dish_list/price?dish_id=1&item=honey_seasame_chicken&item=black_pepper_angus_steak&item=fried_rice <br>
 * Ex Response: {"price":16.79} <br>
 *  <br>
 * - Order Price Query By ID <br>
 * Route: /dish_list/price_by_id?dish_id={id}&item={item_id}&item={item_id}... <br>
 * Ex: https://panda-express-deployment-3.onrender.com/dish_list/price_by_id?dish_id=1&item=2&item=5&item=10 <br>
...
// https://panda-express-deployment-3.onrender.com/dish_list/price?dish_id=1&item=1&item=2&item=14&item=15&item=20
// https://panda-express-deployment-3.onrender.com/dish_list/price?dish_id=1&item=honey_seasame_chicken&item=black_pepper_angus_steak&item=fried_rice
router.get("/price", async (req, res) => {
  ...
  if (Array.isArray(itemIDList)) {
    //Have to Check if it's an array or else when there's a single item it iterates over every letter
