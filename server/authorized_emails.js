 ...
 * Ex: https://panda-express-deployment-3.onrender.com/authorized_emails/summary <br>
 * Ex Response: [{"email":"alex.m.deyoung@tamu.edu"},{"email":"casazzan@tamu.edu"},...] <br>
 *  <br>
 * - Add email <br>
 * Route:  /authorized_emails/add?email={email} <br>
 * Ex: https://panda-express-deployment-3.onrender.com/authorized_emails/add?email={email} <br>
