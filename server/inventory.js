 ...
 * Ex: https://panda-express-deployment-3.onrender.com/inventory?id=3 <br>
 ...
 * Ex: https://panda-express-deployment-3.onrender.com/inventory?name=black_pepper_angus_steak <br>
 * Ex Response: {"item_id":3,"item_name":"black_pepper_angus_steak","servings":"12.00","restock_quantity":300,"item_price":"4.02","food_type":"entree","minimum_amount":50} <br>
 *  <br>
 ...
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/add?id21=&name=testname&servings=10&restock_quantity=30&price=3.21&food_type=entree&minimum_amount=50 <br>
 * Ex Response: No response <br>
 *  <br>
 * - Remove Item From Inventory <br>
 * Route: /innentory/delete?id={item_id} <br>
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/delete?id=22 <br>
 * Ex Response: No response <br>
 *  <br>
 * - Subtract Servings From Item <br>
 * Route: /inventory/subtract?id={id}&servings={number of servings} <br>
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/subtract?id=3&servings=1 <br>
 * Ex Response: No response <br>
 *  <br>
 * - Update Servings For Item <br>
 * Route: /inventory/update_servings?id={id}&servings={number of servings} <br>
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/update_servings?id=3&servings=12 <br>
 * Ex Response: No response <br>
 *  <br>
 * - Update Price For Item <br>
 * Route: /inventory/update_price?id={id}&price={new price} <br>
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/update_price?id=3&price=4.01 <br>
 * Ex Response: No response <br>
 *  <br>
 * - Get Full Inventory <br>
 * Route: /inventory/summary <br>
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/summary <br>
 ...
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/nextID <br>
 * Ex Response: {"nextID":22} <br>
 *  <br>
 * - Restock Full Inventory <br>
 * Route: /inventory/restock <br>
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/restock <br>
 * Ex Response: No response <br>
 *  <br>
 * - Restock Critical Inventory <br>
 * Route: /inventory/critical_restock <br>
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/critical_restock <br>
 * Ex Response: No response <br>
 *  <br>
 * - Get Seasonal Items <br>
 * Route: /inventory/seasonal_items <br>
 * Ex: https://panda-express-deployment-3.onrender.com/inventory/seasonal_items <br>
...
router.get("/restock", (req, res) => {
  ...
  pool.query(data_query).then((query_res) => {
